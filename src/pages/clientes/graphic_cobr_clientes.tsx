...
const Componente_graphic_cobr_clientes = () => {
  // const DATA_API = import.meta.env.PUBLIC_CLIENTES_GRAPHIC_FACT_C;
...
export default Componente_graphic_cobr_clientes;